  ...
  CupertinoThemeData createPreviousRouteTheme(
    ...
    if (cTheme.scaffoldBackgroundColor is CupertinoDynamicColor) {
      ...
      final scaffoldBackgroundColor =
        ...
        highContrastColor: dynamicScaffoldBackgroundColor.highContrastColor,
    ...
    if (cTheme.barBackgroundColor is CupertinoDynamicColor) {
      ...
      final barBackgroundColor =
          CupertinoDynamicColor.withBrightnessAndContrast(
        color: dynamicBarBackgroundColor.color,
        darkColor: dynamicBarBackgroundColor.darkColor,
        highContrastColor: dynamicBarBackgroundColor.highContrastColor,
        darkHighContrastColor: dynamicBarBackgroundColor.darkHighContrastColor,
      );
      ...
      previousRouteTheme = previousRouteTheme.copyWith(
        barBackgroundColor: ColorTween(
          begin: barBackgroundColor.resolveFrom(context),
